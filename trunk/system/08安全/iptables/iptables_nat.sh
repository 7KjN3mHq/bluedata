...
ALLOWED="20 21 22 80 81 9981 9982 9983 9984 9985 9986"
...
$IPTABLES -t nat -A POSTROUTING -s 192.168.6.0/24 -o $EXT_IFACE -j MASQUERADE
$IPTABLES -t nat -A PREROUTING -i $EXT_IFACE -p tcp --dport 8080 -j DNAT --to-destination 192.168.6.3:8080
$IPTABLES -t nat -A PREROUTING -i $EXT_IFACE -p tcp --dport 3721 -j DNAT --to-destination 192.168.6.1:3306
$IPTABLES -t nat -A PREROUTING -i $EXT_IFACE -p tcp --dport 4700 -j DNAT --to-destination 192.168.6.1:4700
