...
'weblayers','Weblayers',
# Common robots (Not in robot file)
'sosospider','<a href="http://help.soso.com/webspider.htm"  target="_blank">SosoSpider</a>',
'youdaobot','<a href="http://www.youdao.com/help/webmaster/spider/"  target="_blank">YoudaoBot</a>',
'doubanbot','<a href="http://www.douban.com"  target="_blank">DoubanBot</a>',
'friendfeedbot','<a href="FriendFeedBot"  target="_blank">FriendFeedBot</a>',
'antibot','Antibot',
